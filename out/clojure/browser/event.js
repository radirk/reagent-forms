...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj10703 = {};return obj10703;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__9243__auto__ = this$;if(and__9243__auto__)
...
{var x__9882__auto__ = (((this$ == null))?null:this$);return (function (){var or__9255__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__9882__auto__)]);if(or__9255__auto__)
{return or__9255__auto__;
} else
{var or__9255__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__9255__auto____$1)
...
return (function (p__10704){var vec__10705 = p__10704;var k = cljs.core.nth.call(null,vec__10705,(0),null);var v = cljs.core.nth.call(null,vec__10705,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__10706){var vec__10707 = p__10706;var k = cljs.core.nth.call(null,vec__10707,(0),null);var v = cljs.core.nth.call(null,vec__10707,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
