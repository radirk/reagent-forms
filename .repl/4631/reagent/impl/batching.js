...
reagent.impl.batching.next_tick = ((cljs.core.not.call(null,reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__9255__auto__ = w.requestAnimationFrame;if(cljs.core.truth_(or__9255__auto__))
{return or__9255__auto__;
} else
{var or__9255__auto____$1 = w.webkitRequestAnimationFrame;if(cljs.core.truth_(or__9255__auto____$1))
{return or__9255__auto____$1;
} else
{var or__9255__auto____$2 = w.mozRequestAnimationFrame;if(cljs.core.truth_(or__9255__auto____$2))
{return or__9255__auto____$2;
} else
{var or__9255__auto____$3 = w.msRequestAnimationFrame;if(cljs.core.truth_(or__9255__auto____$3))
...
var n__10111__auto__ = a.length;var i = (0);while(true){
if((i < n__10111__auto__))
{var C_15356 = (a[i]);if(cljs.core.truth_(C_15356.cljsIsDirty))
{C_15356.forceUpdate();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__9822__auto__,writer__9823__auto__,opt__9824__auto__){return cljs.core._write.call(null,writer__9823__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(C){var and__9243__auto__ = !((C == null));if(and__9243__auto__)
{var and__9243__auto____$1 = (C["props"]);if(cljs.core.truth_(and__9243__auto____$1))
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_15358 = C.cljsRatom;if(!((ratom_15358 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_15358);
} else
{}
