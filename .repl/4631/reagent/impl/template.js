...
reagent.impl.template.valid_tag_QMARK_ = (function valid_tag_QMARK_(x){var or__9255__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);if(or__9255__auto__)
...
{return (function() { 
var G__15373__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__9255__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__9255__auto__))
{return or__9255__auto__;
} else
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__15376 = res;(G__15376[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__15376;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__15377){var vec__15379 = p__15377;var id = cljs.core.nth.call(null,vec__15379,(0),null);var class$ = cljs.core.nth.call(null,vec__15379,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_15380 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_15380 === "key")))
{(o[pname_15380] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__15383 = jsprops;(G__15383["defaultValue"] = value);
(G__15383["value"] = null);
(G__15383["onChange"] = ((function (G__15383,on_change,value){
return (function (p1__15381_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__15381_SHARP_);
});})(G__15383,on_change,value))
);
return G__15383;
}
});
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__15389 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__15389,(0),null);var id = cljs.core.nth.call(null,vec__15389,(1),null);var class$ = cljs.core.nth.call(null,vec__15389,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__9255__auto__ = id;if(cljs.core.truth_(or__9255__auto__))
{return or__9255__auto__;
} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__15391 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__15391,(0),null);var id_class = cljs.core.nth.call(null,vec__15391,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj15395 = {};(obj15395[reagent.impl.util.cljs_argv] = v);
(obj15395[reagent.impl.util.cljs_level] = level);
return obj15395;
})();var k_15396 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__15397 = (((k_15396 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_15396);if((k_SINGLEQUOTE__15397 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__15397);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__10111__auto___15398 = a.length;var i_15399 = (0);while(true){
if((i_15399 < n__10111__auto___15398))
{(a[i_15399] = reagent.impl.template.as_component.call(null,(a[i_15399]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__10111__auto___15401 = a.length;var i_15402 = (0);while(true){
if((i_15402 < n__10111__auto___15401))
{if((i_15402 >= first_child))
{(a[i_15402] = reagent.impl.template.as_component.call(null,(a[i_15402]),level));
} else
{}
{
